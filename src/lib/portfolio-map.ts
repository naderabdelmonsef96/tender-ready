...
export const PRODUCT_SELECT =
  "id, catalogue_id, code, name, name_ar, unit, brand, category, base_cost, currency, is_active, product_specifications(spec_key, spec_value, unit), stock_positions(warehouse, quantity, lead_time_days)";
